...
// 						r,
// 						math.NewInt(1000),
// 						math.LegacyNewDecFromInt(s.getBalance(orderer, "denom2").Amount).QuoTruncate(price).TruncateInt())
...
// 	s.createRangedPool(
// 		s.addr(10000), pair.Id, utils.ParseCoins("1000000000denom1,1000000000denom2"),
// 		math.LegacyNewDecWithPrec(1, 8), math.LegacyNewDecFromInt(math.NewIntWithDecimal(1, 20)), utils.ParseDec("1.0"), true)
// 	fuzz()
// }
