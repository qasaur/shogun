...
type Pair struct {
    ...
    LastPrice      math.LegacyDec // the last swap price of the pair
...
type Pool struct {
    ...
    MinPrice              *math.LegacyDec // the minimum price of ranged pool, nil for basic pools
    MaxPrice              *math.LegacyDec // the maximum price of ranged pool, nil for basic pools
...
type Order struct {
    ...
    Price              math.LegacyDec         // order price of the swap message
    Amount             math.Int         // order amount in base coin of the swap message
    OpenAmount         math.Int         // remaining order amount in base coin after matching
