...
type Orderer interface {
	Order(dir OrderDirection, price math.LegacyDec, amt math.Int) Order
}
...
func (orderer BaseOrderer) Order(dir OrderDirection, price math.LegacyDec, amt math.Int) Order {
...
func NewBaseOrder(dir OrderDirection, price math.LegacyDec, amt, offerCoinAmt math.Int) *BaseOrder {
	return &BaseOrder{
		Direction:                dir,
		Price:                    price,
		Amount:                   amt,
...
func (order *BaseOrder) GetPrice() math.LegacyDec {
	return order.Price
}
