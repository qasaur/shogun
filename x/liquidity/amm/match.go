...
func FillOrder(order Order, amt math.Int, price math.LegacyDec) (quoteCoinDiff math.Int) {
...
func FulfillOrder(order Order, price math.LegacyDec) (quoteCoinDiff math.Int) {
...
// at given price.
func FulfillOrders(orders []Order, price math.LegacyDec) (quoteCoinDiff math.Int) {
	quoteCoinDiff = sdk.ZeroInt()
...
func FindMatchPrice(ov OrderView, tickPrec int) (matchPrice math.LegacyDec, found bool) {
...
func (ob *OrderBook) FindMatchableAmountAtSinglePrice(matchPrice math.LegacyDec) (matchableAmt math.Int, found bool) {
	type Side struct {
		ticks             []*orderBookTick
...
// at the price.
func (ob *OrderBook) MatchAtSinglePrice(matchPrice math.LegacyDec) (quoteCoinDiff math.Int, matched bool) {
...
func (ob *OrderBook) PriceDirection(lastPrice math.LegacyDec) PriceDirection {
...
func (ob *OrderBook) Match(lastPrice math.LegacyDec) (matchPrice math.LegacyDec, quoteCoinDiff math.Int, matched bool) {
...
func DistributeOrderAmountToTick(tick *orderBookTick, amt math.Int, price math.LegacyDec) (quoteCoinDiff math.Int) {
	remainingAmt := amt
	quoteCoinDiff = sdk.ZeroInt()
...
func DistributeOrderAmountToOrders(orders []Order, amt math.Int, price math.LegacyDec) (quoteCoinDiff math.Int) {
