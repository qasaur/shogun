...
// 		utils.ParseDec("1.0"), math.NewInt(1000000), time.Minute)
// }
...
// 	demandCoinDenom string, price math.LegacyDec, amt math.Int, orderLifespan time.Duration) {
